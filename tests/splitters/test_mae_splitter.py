...
def test_mae_splitter(training_data_1d):
    ...
    coeffs, cutpoint, cost = mae_splitter.select_feature_to_cut(training_data, 2)
...
def test_min_samples_leaf_affects_mae_split(training_data_1d):
    ...
    coeffs, cutpoint, cost = mae_splitter.select_feature_to_cut(training_data, len(training_data.X) / 2)
